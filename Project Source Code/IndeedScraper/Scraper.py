import config
import Functions.FileWriter as FileWriter
import Functions.DriverFunctions as DriverFunctions
import Functions.ChromeDriver as ChromeDriver
...
driver = ChromeDriver.launchDriver()
driver2 = ChromeDriver.launchDriver()
